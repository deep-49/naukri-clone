      ...
      <div className="flex-grow">
        ...
        <div className="flex flex-wrap gap-2 mb-3">
          {contest.tags.map((tag) => (
            <span key={tag} className="text-slate-500 bg-slate-50 rounded-2xl px-3 py-1 text-sm">#{tag}</span>
          ))}
        </div>
        <div className="flex items-center justify-between text-sm">
          <span className="text-purple-600 bg-slate-50 rounded-2xl px-3 py-1">
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-3">
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <div className="space-y-3">
              <button className="w-45 m-3 py-2 px-4 border border-blue-500 text-blue-500 rounded-xl hover:bg-blue-50 transition-colors">
                Log in
              </button>
              <button className="w-45 py-2 px-4 bg-red-500 text-white rounded-xl hover:bg-red-600 transition-colors">
                Register
              </button>
            </div>
          </div>
        ...
        <div className="md:col-span-6 bg-white rounded-2xl shadow-md p-6 ">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl m-2 font-bold">Participate in exciting contests</h2>
            <a href="#" className="text-blue-500 text-xl font-bold hover:underline">View all</a>
          </div>
